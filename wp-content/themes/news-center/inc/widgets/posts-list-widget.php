<?php
if ( ! class_exists( 'News_Center_Posts_List_Widget' ) ) {
	/**
	 * Adds News_Center_Posts_List_Widget Widget.
	 */
	class News_Center_Posts_List_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'news_center_magazine_list_widget',
				__( 'Ascendoor Posts List Widget', 'news-center' ),
