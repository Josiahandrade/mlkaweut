<?php
if ( ! class_exists( 'News_Center_Posts_Carousel_Widget' ) ) {
	/**
	 * Adds News_Center_Posts_Carousel_Widget Widget.
	 */
	class News_Center_Posts_Carousel_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$news_center_post_carousel_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-post-carousel-section',
				'description' => __( 'Retrive Posts Carousel Widgets', 'news-center' ),
			);
			parent::__construct(
				'news_center_posts_carousel_widget',
				__( 'Ascendoor Posts Carousel Widget', 'news-center' ),
				$news_center_post_carousel_widget_ops
			);
		}
