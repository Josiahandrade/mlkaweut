<?php
if ( ! class_exists( 'News_Center_Posts_Small_List_Widget' ) ) {
	/**
	 * Adds News_Center_Posts_Small_List_Widget Widget.
	 */
	class News_Center_Posts_Small_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$news_center_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-small-list-section style-1',
				'description' => __( 'Retrive Posts List Widgets', 'news-center' ),
			);
			parent::__construct(
				'news_center_magazine_small_list_widget',
				__( 'Ascendoor Posts Small List Widget', 'news-center' ),
				$news_center_list_widget_ops
			);
		}
