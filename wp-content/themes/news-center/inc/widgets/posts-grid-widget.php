<?php
if ( ! class_exists( 'News_Center_Posts_Grid_Widget' ) ) {
	/**
	 * Adds News_Center_Posts_Grid_Widget Widget.
	 */
	class News_Center_Posts_Grid_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$news_center_grid_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-grid-section style-1',
				'description' => __( 'Retrive Posts Grid Widgets', 'news-center' ),
			);
			parent::__construct(
				'news_center_magazine_grid_widget',
				__( 'Ascendoor Posts Grid Widget', 'news-center' ),
				$news_center_grid_widget_ops
			);
		}
