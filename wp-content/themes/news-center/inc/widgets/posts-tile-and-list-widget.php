<?php
if ( ! class_exists( 'News_Center_Posts_Tile_And_List_Widget' ) ) {
	/**
	 * Adds News_Center_Posts_Tile_And_List_Widget Widget.
	 */
	class News_Center_Posts_Tile_And_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$news_center_tile_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-tile-list-section style-1',
				'description' => __( 'Retrive Tile And List Widgets', 'news-center' ),
			);
			parent::__construct(
				'news_center_magazine_tile_list_widget',
				__( 'Ascendoor Tile And List Widget', 'news-center' ),
				$news_center_tile_list_widget_ops
			);
		}
							...
							<div class="mag-post-single has-image <?php echo esc_attr( $i == 1 ? 'tile-design' : 'list-design' ); ?>">
								...
								<div class="mag-post-detail">
									<div class="mag-post-category <?php echo esc_attr( 1 === $i ? 'with-background' : '' ); ?>">
										...
										news_center_categories_list( $with_background );
										?>
									</div>
		...
		public function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Section Title:', 'news-center' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_label' ) ); ?>"><?php esc_html_e( 'View All Button:', 'news-center' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_link' ) ); ?>"><?php esc_html_e( 'View All Button URL:', 'news-center' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'news-center' ); ?></label>
