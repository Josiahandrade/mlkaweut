<?php
if ( ! class_exists( 'News_Center_Posts_Tile_Widget' ) ) {
	/**
	 * Adds News_Center_Posts_Tile_Widget Widget.
	 */
	class News_Center_Posts_Tile_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$news_center_tile_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-tile-section style-1',
				'description' => __( 'Retrive Posts Tile Widgets', 'news-center' ),
			);
			parent::__construct(
				'news_center_magazine_tile_widget',
				__( 'Ascendoor Posts Tile Widget', 'news-center' ),
				$news_center_tile_widget_ops
			);
		}
